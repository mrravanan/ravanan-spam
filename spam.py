...
# -----------------------------------------------------------
# There is no author for this Sc except ./Perfectly Designed Mr ravanan
# Update 26 january 2020 21:57
# Recode!, YT mr ravanan
# Thanks For MyFriends
...
def logo():
	os.system('clear')
	auth=m+'  Author : '+k+'./ranjith | Modified By: MR RAVANAN'
